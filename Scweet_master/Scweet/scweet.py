...
def scrape(since, until=None, words=None, to_account=None, from_account=None, mention_account=None, interval=1, lang=None,
          headless=True, limit=float("inf"), display_type="Latest", resume=False, proxy=None, hashtag=None, 
